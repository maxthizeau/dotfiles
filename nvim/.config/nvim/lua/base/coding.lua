...
^ ^  _q_: Quit
					...
					return {
						...
						heads = {
							...
							{
								"S",
								cmd("w|lua require('neotest').summary.toggle()"),
								desc = "Summary",
							},
							{
								"a",
								cmd("w|lua require('neotest').run.attach()"),
								desc = "Attach",
							},
							{
								"d",
							...
							{
								"f",
								cmd("w|lua require('neotest').run.run(vim.fn.expand('%'))"),
								desc = "File",
							},
							{
								"l",
								cmd("w|lua require('neotest').run.run_last()"),
								desc = "Last",
							},
							{
								"n",
								cmd("w|lua require('neotest').run.run()"),
								desc = "Nearest",
							},
							{
								"o",
								cmd("w|lua require('neotest').output.open({ enter = true })"),
								desc = "Output",
							},
							{
								"s",
								cmd("w|lua require('neotest').run.stop()"),
								desc = "Stop",
							},
							{
								"q",
