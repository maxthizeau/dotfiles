return {
  ...
  require("custom.base.plugins.autopair"),
  require("custom.base.plugins.harpoon"),
  require("custom.base.plugins.utils"),
  require("custom.base.plugins.refactoring"),
  {
  ...
  },
  {
    ...
    opts = function()
      ...
      return {
        ...
        -- Disable mapping - I don't know what it does yet, I don't want to conflict with my current config
